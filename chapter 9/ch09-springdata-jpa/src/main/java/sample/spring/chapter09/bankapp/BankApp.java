...
public class BankApp {
	...
	public static void main(String args[]) throws Exception {
		...
		*/
		...
		logger.info("findByTenure(tenure, pageable) : " + fixedDepositService.findByTenure(6, new PageRequest(1, 10)));
		...
		Slice<FixedDepositDetails> slice = fixedDepositService.findByFdAmount(500, new PageRequest(0, 2));
		if (slice.hasContent()) {
